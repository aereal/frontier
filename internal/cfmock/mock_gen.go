...
func (m *MockCloudFrontClient) DescribeFunction(ctx context.Context, params *cloudfront.DescribeFunctionInput, optFns ...func(*cloudfront.Options)) (*cloudfront.DescribeFunctionOutput, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, params}
	for _, a := range optFns {
		varargs = append(varargs, a)
...
func (mr *MockCloudFrontClientMockRecorder) DescribeFunction(ctx, params any, optFns ...any) *MockCloudFrontClientDescribeFunctionCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeFunction", reflect.TypeOf((*MockCloudFrontClient)(nil).DescribeFunction), varargs...)
	return &MockCloudFrontClientDescribeFunctionCall{Call: call}
}

// MockCloudFrontClientDescribeFunctionCall wrap *gomock.Call
type MockCloudFrontClientDescribeFunctionCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockCloudFrontClientDescribeFunctionCall) Return(arg0 *cloudfront.DescribeFunctionOutput, arg1 error) *MockCloudFrontClientDescribeFunctionCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockCloudFrontClientDescribeFunctionCall) Do(f func(context.Context, *cloudfront.DescribeFunctionInput, ...func(*cloudfront.Options)) (*cloudfront.DescribeFunctionOutput, error)) *MockCloudFrontClientDescribeFunctionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockCloudFrontClientDescribeFunctionCall) DoAndReturn(f func(context.Context, *cloudfront.DescribeFunctionInput, ...func(*cloudfront.Options)) (*cloudfront.DescribeFunctionOutput, error)) *MockCloudFrontClientDescribeFunctionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
